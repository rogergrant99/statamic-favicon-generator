<template>
    <div>
        ...
        <stack v-if="isOpen" narrow name="generating-modal" @closed="isOpen = false">
            <div class="p-6 text-center">
                <h2 class="text-xl font-medium mb-4">Generating Favicons</h2>
                <div role="status">
                    <svg aria-hidden="true" class="inline w-8 h-8 animate-spin" viewBox="0 0 100 101" style="color: #eef2f6" fill="#2D9EFC" xmlns="http://www.w3.org/2000/svg">
            ...
            Statamic.$axios.post('/cp/favicon-generator/update', this.values)
                .then((response) => {
                    ...
                    if (response.data.status === 'success') {
                        ...
                        // Update generated_at if returned
